...
Original file is located at
    https://colab.research.google.com/drive/19SXx5CHMIme5Vkh8mBjWgHORo_YCMuq1
"""
...
# using the ZipFile library to interact with zip files
...
# you can list the files using a shell command.
!ls

# now you can access the specific file you want to read using pd.read_csv
df = pd.read_csv('output.csv') # replace 'output.csv' with the actual file name
